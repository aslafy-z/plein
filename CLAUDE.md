...
| route | map fills the stage; avoid chips over it under the endpoint fields during setup; form → timeline in a bottom sheet, CTA on its bottom edge | map fills the stage; form → timeline in the floating panel, endpoint fields in the overlay row |
