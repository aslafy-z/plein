...
| Géocodage & autocomplétion | [Base Adresse Nationale](https://adresse.data.gouv.fr/) (api-adresse.data.gouv.fr) · [CartoCiudad](https://www.cartociudad.es) pour l'Espagne · index local pour l'Andorre | Licence Ouverte / Open Licence · CC BY 4.0 |
